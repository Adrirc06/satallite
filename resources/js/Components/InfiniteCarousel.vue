<template>
    <section class="hero-section" id="start">
        ...
        <div class="hero-overlay">
            <div class="px-4 py-5 my-5 text-center hero-content">
                <img class="d-block mx-auto mb-4 hero-logo" src="../../img/logo.png" alt="Logo de SATAllite" />
                <h1 class="display-5 fw-bold quantico-bold text-light">SATAllite</h1>
                <div class="col-lg-6 mx-auto">
                    <p class="lead mb-4 tw:text-white">
                        ¡Bienvenido a SATAllite! Prueba nuestro configurador de PCs o
                        ponte al día con las últimas noticias del mundo tecnológico.
                    </p>
