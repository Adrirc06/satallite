<template>
    ...
    <main class="flex-grow-1 container py-5 d-flex flex-column tw:gap-6">
        ...
        <div class="mt-4 tw:flex tw:flex-col tw:flex-1">
            ...
            <div class="tw:border-2 tw:border-dashed tw:border-gray-300 tw:rounded-lg tw:min-h-48 tw:flex-1 tw:flex tw:justify-center tw:items-center tw:text-gray-500">
                Todavía no tienes ninguna build.
            </div>
        </div>
    </main>
    <Footer/>
