...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $article = Article::create([
            ...
            'user_id' => 1,
            'date' => '2026-01-15',
            'content' => 'El estándar SO-DIMM, que ha dominado la industria de las computadoras portátiles por décadas, finalmente se enfrenta a su sucesor definitivo. El nuevo formato CAMM2 (Compression Attached Memory Module) no es solo una actualización estética, sino una reingeniería total de cómo la memoria RAM se conecta a la placa base. Al eliminar la necesidad de ranuras verticales voluminosas y acortar las pistas eléctricas entre el procesador y la memoria, este diseño permite reducir drásticamente el grosor de los equipos, facilitando la creación de portátiles más potentes y, al mismo tiempo, más compactos.^ Más allá del ahorro de espacio, la verdadera ventaja de CAMM2 reside en su capacidad para romper las barreras de velocidad y eficiencia energética. Mientras que los módulos tradicionales sufrían de degradación de señal al intentar alcanzar frecuencias extremadamente altas, la tecnología CAMM2 permite implementar memorias LPDDR5X de doble canal en un solo módulo sustituible. Esto significa que los usuarios ya no tendrán que elegir entre la velocidad de la memoria soldada y la versatilidad de la memoria reemplazable; el nuevo estándar ofrece lo mejor de ambos mundos, marcando el inicio de una era donde el alto rendimiento y la reparabilidad van de la mano.',
        ]);
        $article = Article::create([
