...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $article = Article::create([
            ...
            'banner_url' => '/img/banners/banner6.webp',
            'user_id' => 1,
            'date' => '2026-04-05',
        ...
        $article = Article::create([
            ...
            'banner_url' => '/img/banners/banner2.webp',
            'user_id' => 1,
            'date' => '2026-03-02',
        ...
        $article = Article::create([
            ...
            'banner_url' => '/img/banners/banner5.webp',
            'user_id' => 1,
            'date' => '2026-02-10',
        ...
        $article = Article::create([
            ...
            'banner_url' => '/img/banners/banner4.webp',
            'user_id' => 1,
            'date' => '2025-11-12',
